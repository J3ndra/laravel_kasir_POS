...
<template>
    ...
    >
        ...
        <template v-slot:content>
            <div
                class="w-full flex justify-between my-4"
            ...
            >
                ...
                <div class="flex my-auto">
                    <div class="text-sm font-normal text-slate-400 italic mr-2">
                        Active
                    </div>
                    <div class="form-switch">
                        <input
                            type="checkbox"
                            :id="subGroup.group + '_' + index"
                            class="sr-only"
                            @change="cek(subGroup)"
                            :checked="
