    ...
    <VDialog :showModal="openDialog" title="Detail Transaction" size="xl">
        ...
        <template v-slot:content>
            ...
            <div class="grid grid-cols-2 gap-2">
                <div>
                    <div class="font-medium text-sm text-slate-600 mb-1">
                        Invoice
                    </div>
                ...
                <div>
                    ...
                    <div class="font-normal text-sm text-slate-500">
                        Rp{{ data.grand_total_formatted }}
                    </div>
                </div>
            </div>

            <!-- List Product -->
            <div class="font-semibold text-slate-800 text-base my-4">
                List Product
            </div>
            <VDataTable :heads="heads" wrapperClass="!px-0">
                <tr
                    v-for="(data, index) in data.transaction_details"
                    :key="index"
                >
